...
export TASK_PROMPT="Add $SPEC_FILE to references links. Extract the relevant information and create the task. The task should be clear, concise, and actionable. It should capture the essence of the specification and provide a clear direction for implementation."
