...
| --- | --------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | Create run branch           | current `HEAD`                                                                                                             | `git switch -c <head-branch>-<YYYYMMDDHHMMSS>` from HEAD; abort if working tree dirty (uncommitted changes) — ask user to stash/commit first                                                          |
