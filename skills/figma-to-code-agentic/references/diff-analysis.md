...
When SSIM score is below 0.95, use this guide to systematically diagnose and fix differences.
...
| 0.95–0.97 | Production-ready | Ship it |
...
**Note:** SSIM below 0.95 due to font rendering alone (not layout) is usually acceptable. Check the diff image visually — if the diff is only in text subpixels, call it done.
