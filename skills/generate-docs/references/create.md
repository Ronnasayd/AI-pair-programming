...
7. If ambiguity remains after investigation (unclear module purpose, unclear target audience, or missing context no tool can resolve), use `/grilling` to ask the user targeted clarifying questions before proceeding.
