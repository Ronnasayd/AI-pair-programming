---
name: ai-setup-audit
description: Use this prompt to audit your AI setup. It will analyze your claude.md, skills, context, and instructions to identify redundancies, conflicts, and areas for improvement.
---
...
check my claude.md, every skill in my skills folder, every file in my context folder, and any other instruction files you can find.

then go through every rule, instruction, and preference you found.
