...
Check the definitions in `.claude/skills/generate-docs/references/templates/docs-adr.md` and consider offering to create an ADR when the criteria are met.
