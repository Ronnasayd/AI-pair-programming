---
name: save-session
description: Save current session state to a dated file in docs/agents/sessions/ so work can be resumed in a future session with full context.
---
