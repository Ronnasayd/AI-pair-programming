...
alias hwc="ANTHROPIC_MODEL=claude-sonnet-5 ENABLE_TOOL_SEARCH=auto:15 headroom wrap claude --1m -- " # Run Claude wrapped by headroom with 1M context, tool search disabled: headroom-wrap-claude
