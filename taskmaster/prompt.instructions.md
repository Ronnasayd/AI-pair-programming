...
<attachments>
filepath: {{reference to files, links, etc that may assist in implementation}}
#filepath: {{reference to files, links, etc that may assist in implementation}} // will not be added
<attachments>
